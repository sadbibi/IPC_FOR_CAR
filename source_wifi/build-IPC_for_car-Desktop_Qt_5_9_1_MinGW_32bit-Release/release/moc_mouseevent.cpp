...
#include "C:/Users/hp/Desktop/source/IPC_for_car/mouseevent.h"
...
QT_MOC_LITERAL(1, 11, 11), // "getPosition"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 2) // "pt"

    },
    "MouseEvent\0getPosition\0\0pt"
};
...
void MouseEvent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MouseEvent *_t = static_cast<MouseEvent *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getPosition((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MouseEvent::*_t)(QPointF );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MouseEvent::getPosition)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MouseEvent::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_MouseEvent.data,
...
// SIGNAL 0
void MouseEvent::getPosition(QPointF _t1)
{
