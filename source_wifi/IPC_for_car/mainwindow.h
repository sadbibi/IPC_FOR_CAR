...
signals:
    ...
    void sendDatatoInstruct(QByteArray data);      //发送给配置栏

public slots:
    void handleResults(QByteArray result);
private slots:
    void setStatusBar(int x,int y);
    ...
    void Ip_show(QString address);

    void Instruct_To_Serial(QByteArray data);
...
extern QString IPADRRS;
extern bool INSTRCT_flag;
#endif // MAINWINDOW_H
